...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, help="the path of data downloaded")
    parser.add_argument("--lat_top", type=float, help="the latitude of the left top coord")
    parser.add_argument("--lon_left", type=float, help="the longitude of the left top coord")
    parser.add_argument("--lat_down", type=float, help="the latitude of the right down coord")
    parser.add_argument("--lon_right", type=float, help="the longitude of the right down coord")
    parser.add_argument("--data_source", type=int, help="the source of geo-data")
    parser.add_argument("--zoom", type=int, help="the zoom of geo")
    args = parser.parse_args()

    jsonstring={"mainpath": args.data_path, 
        "datasetname": args.dataset_name, 
        "coordinates": [args.lat_top, args.lon_left, args.lat_down, args.lon_right],
        "datas":[{"datasource": args.data_source, 'zooml': args.zoom, 'zoomhlist':[args.zoom]}]}
